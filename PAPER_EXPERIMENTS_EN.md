...
host-only network, allow-listed, and logged. (The multi-LLM study in E.7 uses a 6-box subset of these.)
...
## E.7 Robustness — does the result hold across LLM vendors?
